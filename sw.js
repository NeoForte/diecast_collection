...
const ASSETS = [
  ...
  './styles.css?v=4.0.9',
  './app.js?v=4.0.9',
  './showcase-sync.js?v=4.0.9',
  './manifest.webmanifest?v=4.0.9',
  './jszip.min.js?v=4.0.9',
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.pathname.endsWith('/showcase-sync.js')) {
    event.respondWith(
      fetch('./showcase-sync.js?v=4.0.9', { cache:'no-store' })
        .catch(() => caches.match('./showcase-sync.js?v=4.0.9'))
    )
    return
  }
