...
const ASSETS = [
  ...
  './styles.css?v=4.1.2',
  './app.js?v=4.1.2',
  './showcase-sync.js?v=4.1.2',
  './manifest.webmanifest?v=4.1.2',
  './jszip.min.js?v=4.1.2',
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.pathname.endsWith('/showcase-sync.js')) {
    event.respondWith(
      fetch('./showcase-sync.js?v=4.1.2', { cache:'no-store' })
        .catch(() => caches.match('./showcase-sync.js?v=4.1.2'))
    )
    return
  }
