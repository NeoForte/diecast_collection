...
const ASSETS = [
  ...
  './styles.css?v=4.1.4',
  './app.js?v=4.1.4',
  './showcase-sync.js?v=4.1.4',
  './manifest.webmanifest?v=4.1.4',
  './jszip.min.js?v=4.1.4',
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.pathname.endsWith('/showcase-sync.js')) {
    event.respondWith(
      fetch('./showcase-sync.js?v=4.1.4', { cache:'no-store' })
        .catch(() => caches.match('./showcase-sync.js?v=4.1.4'))
    )
    return
  }
