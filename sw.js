...
const ASSETS = [
  ...
  './styles.css?v=4.0.1',
  './app.js?v=4.0.1',
  './showcase-sync.js?v=4.0.1',
  './manifest.webmanifest?v=4.0.1',
  './jszip.min.js?v=4.0.1',
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.pathname.endsWith('/showcase-sync.js')) {
    event.respondWith(
      fetch('./showcase-sync.js?v=4.0.1', { cache:'no-store' })
        .catch(() => caches.match('./showcase-sync.js?v=4.0.1'))
    )
    return
  }
